...
// Recursive types
//QUIZ:
// which of the following is a recursive type? List
...
pub fn arc() {
    ...
    for _ in 0..10 {
        ...
        let tjh = thread::spawn(move || {
            ...
            println!("{:?}", apple);
            println!(
                "count after creating apple in a thread: {}",
                Arc::strong_count(&apple)
            );
            // What's going on? See:
...
// what Rust principles dictate this design pattern?
// Borrowing rule
//
